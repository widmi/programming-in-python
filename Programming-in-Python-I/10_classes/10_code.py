...
class MyClass:
    ...
    # like attributes (also by the class itself)
    var = 55
...
#
# Recap: Directories as modules
#

# Adding a file "__init__.py" to a folder will make Python recognize the folder
# as module, which is similar to a class. You can then import the module and
# access it similarly to a class instance.
