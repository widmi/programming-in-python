...
# anything).
# Comments in Python start with a hashtag (#). You can also place comments
# after non-comment statements using a hashtag. Since this line starts with a
...
# https://docs.python.org/3.7/reference/expressions.html#evaluation-order
...
another_float = 2e1  # Corresponds to 20.0
...
# // get the floor value of a division
